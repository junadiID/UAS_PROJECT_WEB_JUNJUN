...
?>
				...
				<div class="row">
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="m-t-0 text-uppercase text-center header-title"><i class="mdi mdi-cellphone-iphone mr1 text-primary"></i> PESANAN BARU</h4><hr>
                                	<form class="form-horizontal" method="POST">
	                              	<input type="hidden" name="csrf_token" value="<?php echo $config['csrf_token'] ?>">   										    
											<div class="form-group">
												...
												<?php
												$cek_kategori = $conn->query("SELECT * FROM kategori_layanan WHERE tipe IN ('VOUCHER') ORDER BY nama ASC");
