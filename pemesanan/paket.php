...
?>
			<div class="row">
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="m-t-0 text-uppercase text-center header-title"><i class="mdi mdi-earth mr1 text-primary"></i> PESANAN BARU</h4><hr>
                                	<form class="form-horizontal" method="POST">
	                              	<input type="hidden" name="csrf_token" value="<?php echo $config['csrf_token'] ?>">   										    
											<div class="form-group">
												...
												<?php
												$cek_kategori = $conn->query("SELECT * FROM kategori_layanan WHERE tipe IN ('PKIN') ORDER BY nama ASC");
											...
											<div class="form-group">
												<label class="col-md-12 control-label">Nomor Pelanggan</label>
												<div class="col-md-12">
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                <center><b>WAJIB BACA!!<br/>INFORMASI SEBELUM ORDER</b></center><br/>
			   ...
			   <!-- KE 1 -->  
				...
				<i class="mdi mdi-help-circle mr-1 text-primary"></i>PAKET INTERNET XL COMBO
				</a>
				</h4>
				</div>
				...
				<div class="card-body">
					<ul>
					<li>mohon CEK nomor konsumen di *123*234#</li>
            				<li>Jika muncul Menu: <br /><br /> 1.Terima Paket <br /><br /> Maka Nomor itu Bisa di isi dan bisa di order</li>
				...
				<i class="mdi mdi-help-circle mr-1 text-primary"></i>VOUCHER DATA INTERNET
				</a>
			        </h4>
				</div>
				...
				<div class="card-body">
					<ul>
					<li>Pilih Produk / Layanan yang akan di pesan</li>
					<li>Input nomor hp target</b></li>
					<li>Setelah anda melakukan pemesanan silahkan cek di riwayat pemesanan pulsa</li>
					<li>Pilih bagian detail pemesanan</li>
					<li>Kode voucher tersebut berada di tabel SN/catatan</li>
					</ul>
				</div>
				</div>
				</div>			   
