...
?>
				...
				<div class="row">
                    ...
                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="<?php echo $config['web']['url'] ?>pemesanan/sosial-media">SERVER 1</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo $config['web']['url'] ?>pemesanan/sosial-media-2">SERVER 2</a></li>
                    
                </ul>
                <div class="tab-content">
                
                                <h4 class="m-t-0 text-uppercase text-center header-title"><i class="mdi mdi-instagram mr1 text-primary"></i> PESANAN BARU SERVER 1</h4><hr>
