                                    ...
                                    <ul class="nav nav-pills navtab-bg">
                                        <li class="nav-item">
                                            <a href="#general-q-tab" data-toggle="tab" aria-expanded="false" class="nav-link px-3 py-2 active">
                                                <span class="d-inline-block d-sm-none"><i class="ti ti-help-alt"></i></span>
                                                <span class="d-none d-sm-inline-block"><i class="ti ti-help-alt mr-1"></i> Pertanyaan Umum</span>   
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#privacy-p-tab" data-toggle="tab" aria-expanded="true" class="nav-link px-3 py-2">
                                                <span class="d-inline-block d-sm-none"><i class="ti ti-shield"></i></span>
                                                <span class="d-none d-sm-inline-block"><i class="ti ti-shield mr-1"></i> Terms Of Services</span> 
                                            </a>
                                        </li>
                                        <!--<li class="nav-item">
