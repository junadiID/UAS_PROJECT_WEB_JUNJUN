...
?>
						<div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									<h4 class="m-t-0 m-b-30 header-title"><i class="mdi mdi-book"></i> Dokumentasi API</h4>
<div class="table-responsive">
	<table class="table table-bordered">
		...
		<tr>
			<td>API URL</td>
			<td><?php echo $config['web']['base_url'] ?>api/json</td>
		</tr>
		<tr>
			<td>API ID</td>
			<td><?php echo $login['id'] ?>
		</tr>
		<tr>			
			<td>API KEY</td>
...
<div class="table-responsive">
	<table class="table table-bordered">
		...
		<tr>
			<td>service</td>
			<td>ID Layanan, dapat dilihat di <a href="<?php echo $config['web']['base_url'] ?>page/price_list">Daftar Layanan</a>.</td>
		</tr>
		<tr>
			<td>data</td>
