...
Terimakasih.</p></h6>
				...
				<div class="row">
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="m-t-0 text-uppercase text-center header-title"><i class="ti ti-wallet text-primary"></i> DEPOSIT GOPAY</h4><hr>
										...
										<input type="hidden" name="csrf_token" value="<?php echo $config['csrf_token'] ?>">
											<div class="form-group">
												...
												<?php
												$cek_kategori = $conn->query("SELECT * FROM metode_depo WHERE provider = 'GOPAY' ORDER BY nama ASC");
