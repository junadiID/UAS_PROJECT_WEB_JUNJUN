...
require '../lib/session_login_admin.php'; 
        if (isset($_POST['tambah'])) {
            ...
            if (!$username || !$email || !$password || !$level) {
                ...
                if ($conn->query("INSERT INTO users VALUES ('', '', '$email', '$username', '$hash_pass', '$saldo', '', '$level', 'Aktif', '$api_key', '$sess_username', '$terdaftar', '0','')") == true) {
                ...
                <div class="modal fade bs-example-modal-lg" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" role="form" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-success btn-bordred waves-effect w-md waves-light" name="tambah"><i class="fa fa-plus"></i> Tambah</button>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">   
                                    <button data-toggle="modal" data-target="#addModal" class="btn btn-success btn-bordred waves-effect waves-light m-b-30"><i class="fa fa-plus"></i> Tambah</button>
                                    <form class="form-horizontal" method="POST" style="float: right;">
                                    <!--<button type="submit" name="delete_all" class="btn btn-danger btn-bordred waves-effect waves-light m-b-30"><i class="mdi mdi-delete-variant"></i> Pembersihan</button> -->
                                    </form>
    ...
    ?>                                        
                                            <tr>
                                                ...
                                                <td><?php echo $data_pengguna['api_key']; ?>
                                                 <button type="submit" name="change_api" class="btn btn-sm btn-bordred btn-success"><i class="fa fa-exchange" title="Ganti API Key"></i></button>   
                                                </td>
                                                <td><span class="badge badge-<?php echo $label; ?>"><?php echo $data_pengguna['status']; ?></span></td>
                                                <td align="center">
                                                    <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/pengguna/view?id=<?php echo $data_pengguna['id']; ?>')" class="btn btn-sm btn-primary"><i class="fa fa-list" title="Edit"></i></a>
                                                    <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/pengguna/edit?id=<?php echo $data_pengguna['id']; ?>')" class="btn btn-sm btn-warning"><i class="fa fa-pencil" title="Edit"></i></a>
                                                    <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/pengguna/delete?id=<?php echo $data_pengguna['id']; ?>')" class="btn btn-sm btn-danger"><i class="fa fa-trash" title="Hapus"></i></a>
                                                </td>                                                
                                            </form>
                                            </tr>
<?php } ?>                                        
