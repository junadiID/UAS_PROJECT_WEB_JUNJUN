...
?>        
        <div class="row">
            <div class="col-md-12">
                <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-badgeledby="myModalbadge">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title m-t-0 id="myModalbadge""><i class="mdi mdi-newspaper"></i> Tambah Berita</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-badge="Close">×</button>
                            </div>
                            <div class="modal-body">
                                <form class="form-horizontal" role="form" method="POST">
                                    <div class="form-group row">
                                        <badge class="col-md-2 control-badge">Kategori</badge>
                                        <div class="col-md-10">
                                            <select class="form-control" name="tipe">
                                                ...
                                                <option value="NEW Layanan">NEW Layanan</option>
                                                <option value="OFF Layanan">OFF Layanan</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">   
                                    <button data-toggle="modal" data-target="#addModal" class="btn btn-success btn-bordred waves-effect waves-light m-b-30"><i class="fa fa-plus"></i> Tambah Berita</button> 
...
// end paging config
    ...
    ?>                                        
                                            <tr>
                                                ...
                                                <td><span class="badge badge-<?php echo $badge; ?>"><?php echo $data_berita['tipe']; ?></span></td>
                                                ...
                                                <td align="center">
                                                    <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/berita/edit?id=<?php echo $data_berita['id']; ?>')" class="btn btn-sm btn-warning"><i class="fa fa-pencil" title="Edit"></i></a>
                                                    <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/berita/delete?id=<?php echo $data_berita['id']; ?>')" class="btn btn-sm btn-danger"><i class="fa fa-trash" title="Hapus"></i></a>
                                                </td>
                                            </tr>
<?php } ?>                                        
                                    </tbody>
