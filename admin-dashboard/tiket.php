...
?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="<?php echo $config['web']['url']; ?>admin-dashboard/ajax/tiket/reply?id=<?php echo $data_tiket['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-reply" title="Reply"></i></a>
                                            <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/tiket/tutup?id=<?php echo $data_tiket['id']; ?>')" class="btn btn-sm btn-warning"><i class="fa fa-close" title="Tutup"></i></a>
                                            <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/tiket/hapus?id=<?php echo $data_tiket['id']; ?>')" class="btn btn-sm btn-danger"><i class="fa fa-trash" title="Tutup"></i></a>
                                        </td>
                                    </tr>   
<?php } ?>
                                    </tbody>
