            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                    <button data-toggle="modal" data-target="#addModal" class="btn btn-success btn-bordred waves-effect waves-light m-b-30"><i class="mdi mdi-plus"></i> Tambah Metode Deposit</button> 
                                <h4 class="m-t-0 header-title"><b><i class="fa fa-list"></i>    Metode Deposit </b></h4>                             
                                        <form>
                                            <div class="row">
...
?>
                                    <tr> 
                                        ...
                                        <td><?php echo $data_method['tujuan']; ?></td>
                                        <td align="center">
                                            <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/metode-deposit/edit?data=<?php echo $data_method['id']; ?>')" class="btn btn-sm btn-warning"><i class="fa fa-pencil" title="Edit"></i></a>
                                            <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/metode-deposit/delete?data=<?php echo $data_method['id']; ?>')" class="btn btn-sm btn-danger"><i class="fa fa-trash" title="Hapus"></i></a>
                                        </td>                                 
                                    </tr>  
<?php } ?>
                                    </tbody>
