...
?>
                                ...
                                <div class="card widget-box-three">
                                    <div class="card-body">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <h3 class="m-b-10"><span>Rp <?php echo number_format($data_pesanan_pulsa['total'],0,',','.'); ?> Dari <?php echo $count_pesanan_pulsa; ?> Pesanan</span></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="m-t-0 header-title"><b><i class="fa fa-list"></i>    Pesanan Pulsa</b></h4>                             
                                        <form>
                                            <div class="row">
...
?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="javascript:;" onclick="pembelian_pulsa('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/order/view-pulsa?oid=<?php echo $data_pesanan['oid']; ?>')" class="btn btn-sm btn-primary"><i class="fa fa-eye" title="view"></i></a>
