...
?>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="m-t-0 header-title"><b><i class="fa fa-history"></i> Riwayat Transfer Saldo</b></h4>                               
                                        <form>
                                            <div class="row">
...
?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td class="text-primary"><?php echo $datanya['pengirim'] ?></td>
                                        <td class="text-success"><?php echo $datanya['penerima']; ?></td>
                                        <td width="20%"><span class="badge badge-pill badge-success">Rp <?php echo number_format($datanya['jumlah'],0,',','.'); ?></span></td>
