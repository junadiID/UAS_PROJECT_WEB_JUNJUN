...
?>
                                ...
                                <div class="card widget-box-three">
                                    <div class="card-body">
                                        ...
                                        <div class="text-right">
                                            <p class="text-uppercase font-14 m-b-10 font-600">Total Deposit</p>
                                            <h3 class="m-b-10"><span>Rp <?php echo number_format($data_deposit['total'],0,',','.'); ?> Dari <?php echo $count_deposit; ?> Deposit</span></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="m-t-0 header-title"><b><i class="fa fa-list"></i>    Daftar Deposit</b></h4>                              
                                        <form>
                                            <div class="row">
...
?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="javascript:;" onclick="deposit('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/deposit/view-deposit?kode_deposit=<?php echo $data_depo['kode_deposit']; ?>')" class="btn btn-sm btn-primary"><i class="fa fa-eye" title="view"></i></a>
