...
?>
                                    <tr> 
                                        ...
                                        <td align="center">
                                            <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/pengaturan-website/edit?id=1')" class="btn btn-sm btn-warning"><i class="fa fa-pencil" title="Edit"></i></a>
                                        </td>                                 
                                    </tr>  
<?php } ?>
                                    </tbody>
