...
require '../lib/session_login_admin.php'; 
        ...
        if (isset($_POST['tambah'])) {
            ...
            if (!$sid || !$pid || !$kategori || !$layanan || !$catatan || !$min || !$max || !$harga || !$harga_api || !$profit || !$status || !$provider) {
                ...
                if ($conn->query("INSERT INTO layanan_sosmed VALUES ('', '$sid', '$kategori', '$layanan', '$catatan', '$min', '$max', '$harga', '$harga_api', '$profit', '$status', '$pid', '$provider', '$tipe')") == true) {
...
?>
                                    <tr> 
                                        ...
                                        <td align="center">
                                            <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/layanan-sosmed/edit?id_layanan=<?php echo $data_layanan['id']; ?>')" class="btn btn-sm btn-warning"><i class="fa fa-pencil" title="Edit"></i></a>
                                            <a href="javascript:;" onclick="users('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/layanan-sosmed/delete?id_layanan=<?php echo $data_layanan['id']; ?>')" class="btn btn-sm btn-danger"><i class="fa fa-trash" title="Hapus"></i></a>
                                        </td>                                 
                                    </tr>  
<?php } ?>
                                    </tbody>
