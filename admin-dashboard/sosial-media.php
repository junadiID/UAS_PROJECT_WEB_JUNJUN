...
?>
                                ...
                                <div class="card widget-box-three">
                                    <div class="card-body">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <h3 class="m-b-10"><span>Rp <?php echo number_format($data_pesanan_sosmed['total'],0,',','.'); ?> Dari <?php echo $count_pesanan_sosmed; ?> Pesanan</span></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="m-t-0 header-title"><b><i class="fa fa-list"></i>    Pesanan Sosial Media</b></h4>                              
                                        <form>
                                            <div class="row">
...
?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="javascript:;" onclick="pembelian_sosmed('<?php echo $config['web']['url']; ?>admin-dashboard/ajax/order/view-sosmed?oid=<?php echo $data_pesanan['oid']; ?>')" class="btn btn-sm btn-primary"><i class="fa fa-eye" title="view"></i></a>
                                            <button data-toggle="tooltip" title="Update" type="submit" name="update" class="btn btn-sm btn-bordred btn-warning"><i class="fa fa-edit"></i></button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title mt-0" id="myModalLabel"><i class="mdi mdi-cart-outline"></i> Detail Pemesanan  Sosial Media</h4>
