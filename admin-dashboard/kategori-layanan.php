            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                    <button data-toggle="modal" data-target="#addModal" class="btn btn-success btn-bordred waves-effect waves-light m-b-30"><i class="fa fa-plus"></i> Tambah Kategori</button> 
                                <h4 class="m-t-0 header-title"><b><i class="fa fa-list"></i>    Kategori Layanan</b></h4>                             
                                        <form>
                                            <div class="row">
...
?>
                                    <tr> 
                                        ...
                                        <td align="center">
                                            <button data-toggle="tooltip" title="Update" type="submit" name="edit" class="btn btn-sm btn-bordred btn-warning"><i class="fa fa-edit" title="Edit"></i></button>
                                            <button data-toggle="tooltip" title="Hapus"type="submit" name="delete" class="btn btn-sm btn-bordred btn-danger"><i class="fa fa-trash" title="Hapus"></i></button>
                                        </td> 
                                        </from>                                
                                    </tr>  
<?php } ?>
