	...
	if (isset($_POST['kirim'])) {
		...
		if (!$post_subjek || !$post_pesan) {
			...
			if ($insert_tiket == TRUE) {
				$_SESSION['hasil'] = array('alert' => 'success', 'judul' => 'Sukses', 'pesan' => 'Tiket Berhasil Dibuat, Harap Menunggu Respon Dari Admin.');
			} else {
...
?>
          <div class="row">
               <div class="col-lg-12">
                    <div class="alert alert-primary alert-dismissible">
                         ...
                         <h4><i class="icon fa fa-check"></i> Hai <?php echo $sess_username; ?> !</h4>
		...
		<div class="form-group">
                    	<label class="col-md-2 control-label">Masukan Pesan Anda</label>
                    	<div class="col-md-12">                   	
	    ...
	    <div class="col-md-12">
                 <div class="card-box">
                      <h4 class="header-title mb-3">RIWAYAT TIKET</h4><hr>
                          <div class="table-responsive">
                               <table class="table table-striped table-bordered table-hover m-0">
                               <thead>
...
?>
		...
		<tr>
		     ...
		     <th scope="row"><b><a href="<?php echo $config['web']['url']; ?>tiket/open?id=<?php echo $data_tiket['id']; ?>"</a>#GP-<?php echo $data_tiket['id']; ?></b></th>
