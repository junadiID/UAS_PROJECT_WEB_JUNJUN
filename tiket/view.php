...
?>
		...
		<div class="row">
		    <div class="offset-md-2 col-md-8">
				...
				<img src="../assets/images/user.png" alt="user-image" width="40" height="40" class="rounded-circle">
				<b><div class="text-primary"><?php echo $data_tiket['user']; ?></b></div><br /><?php echo nl2br($data_tiket['pesan']); ?><br /><i style="font-size: 10px;"><div class="text-primary"><?php echo tanggal_indo($data_tiket['date']); ?>, <?php echo $data_tiket['time']; ?></div></i>
											</div>
<?php
...
<center><a href="<?php echo $config['web']['url']; ?>tiket/" class="btn btn-danger"><i  class="mdi mdi-arrow-left-bold"></i> Kembali</a></center>
						</div>						
					</div>					
				</div>				
			</div>			
