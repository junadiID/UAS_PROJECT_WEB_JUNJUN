                            ...
                            <div class="card-body">
                                <h4 class="m-t-0 text-uppercase text-center header-title"><i class="fa fa-history text-primary"></i> Riwayat Deposit Saldo</h4><hr>
                                        <div class="alert alert-info">
                                            <p>Klik Icon <b><i class="mdi mdi-view-list mdi-18px"></i></b> untuk melihat detail deposit.</p>
                                            
                                            <p>Klik Icon <b><i class="mdi mdi-checkbox-marked-outline mdi-18px"></i></b> pada status deposit yang pending untuk MEMBATALKAN / KONFIRMASI .</p>
                                        </div>                                
